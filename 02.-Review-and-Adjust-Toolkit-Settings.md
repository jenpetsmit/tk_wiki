...
4. Save  your _Cloud Access Credentials_ file to your local hardware or to your VM
     * To learn how to collect your credentials file, see [Collect Cloud Access Credentials](03.-Cloud-Credentials.md). 
...
The Tools tab gives you the opportunity to change the location of where prefetched data is downloaded. For more information about the Prefetch tool, see [wiki.html](wiki.html#prefetch)
