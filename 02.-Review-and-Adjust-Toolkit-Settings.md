...
Note: This section presents information on Cloud-based virtual machines (VMs) and buckets. To learn more about, see [SRA in the Cloud](https://www.ncbi.nlm.nih.gov/sra/docs/sra-cloud/).
...
The Tools tab gives you the opportunity to change the location of where prefetched data is downloaded. For more information about the Prefetch tool, see [wiki.html <--NEED BETTER LINK HERE](wiki.html)
