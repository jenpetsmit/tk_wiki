...
1. [Check here](01.-Downloading-SRA-Toolkit.html) to see if there is a newer version 
...
Alternatively, you can use a terminal window and type [vdb-config](toolkit-appendix#vdb-config) commands to adjust settings.  
...
4. Save  your _Cloud Access Credentials_ file to your local hardware or to your VM
     * To learn how to collect your credentials file, see [Collect Cloud Access Credentials](03.-cloud-credentials.html). 
